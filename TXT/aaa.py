...
class FoodApp:
    def __init__(self, root):
        ...
        self.food_color_menu = tk.OptionMenu(self.add_food_frame, self.food_color_var, "Select Color")
        ...
        self.food_category_menu = tk.OptionMenu(self.add_food_frame, self.food_category_var, "Select Category")
