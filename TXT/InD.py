import os
from up import baca_id_terakhir
...
def Data_Makanan():
    ...
    if Warna_data is None:
        ...
        return
    Warna_dict = parsing_dictionary(Warna_data)  # Parsing warna

    Kategori_data = baca_file('Data_Kategori.txt')
    if Kategori_data is None:
        print("File data Kategori tidak ditemukan.")
        return
    Kategori_dict = parsing_dictionary(Kategori_data)  # Parsing kategori
